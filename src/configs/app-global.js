...
export const BASE_URL =
  process.env.REACT_APP_BASE_URL || 'https://api.raioh.com';
export const WEBSITE_URL = 'https://raioh.com/';
...
export const RECAPTCHASITEKEY = '6LfuBXkpAAAAAJH7e0ewH682Qhfsax22mVTGYOYH';
